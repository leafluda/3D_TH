...
void main() {
	...
	while (mat_vec_cal)
	{
		...
		{
		case 0:
			cout << "계산 예시 (번호 입력시 100줄가량의 항목당 예시가 나옵니다.)" << endl;
			cout << "1. 행렬 생성(Mat3, Mat4)" << endl;
			cout << "2. 벡터 생성(Vec3, Vec4)" << endl;
			cout << "3. 행렬 계산" << endl;
			cout << "4. 벡터 계산" << endl;
			cout << "5. 끝내기" << endl;
			cout << "입력(입력후 엔터) : ";
		...
		case 2:
			...
			cout << "1) Vec3" << endl;
			cout << "=====================================================================================" << endl;
			cout << "-1 Vec3 기본 벡터 생성자 초기값 : Vec3 v1" << endl;
			v1.print();
			cout << "-------------------------------------------------------------------------------------" << endl;
			cout << "-2 Vec3 기본 벡터 생성 : Vec3 v2(1,1,1)" << endl;
			v2.print();
			cout << "-------------------------------------------------------------------------------------" << endl;
			...
			cout << "2) Vec4" << endl;
			cout << "=====================================================================================" << endl;
			cout << "-1 Vec4 기본 벡터 생성자 초기값 : Vec4 v3" << endl;
			v3.print();
			cout << "-------------------------------------------------------------------------------------" << endl;
			cout << "-2 Vec4 기본 벡터 생성 : Vec4 v4(1,1,1,1)" << endl;
			v4.print();
			cout << "-------------------------------------------------------------------------------------" << endl;
		...
		case 3:
			...
			cout << "-------------------------------------------------------------------------------------" << endl;
			cout << "-6 Mat4 / double : m8.division_const_matrix(m8, 4)" << endl;
